...
$('.md-search').after('<form class="md-header__option md-header__graph-option"> \
  <label id="graph_button" class="md-header__button md-icon" title="Open graph" aria-label="Open graph"> \
